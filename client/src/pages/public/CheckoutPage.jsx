...
const CheckoutPage = () => {
    ...
    const handleApplyCoupon = async () => {
        ...
        try {
            ...
            const response = await validateCoupon(couponCode.toUpperCase(), subtotal);
        ...
        try {
            ...
            const options = {
                ...
                modal: {
                    ondismiss: function () {
                        setProcessing(false);
                        alert('Payment cancelled. Your order has been created but not paid. You can complete payment later.');
                    }
                }
            };
